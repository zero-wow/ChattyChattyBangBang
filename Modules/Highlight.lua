local mod = ChattyChattyBangBang:NewModule("Highlights", "AceHook-3.0", "AceEvent-3.0", "LibSink-2.0")
...
function mod:OnInitialize()
	self.db = ChattyChattyBangBang.db:RegisterNamespace("Highlight", defaults)
