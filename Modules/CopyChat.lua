...
function mod:OnInitialize()
	self.db = ChattyChattyBangBang.db:RegisterNamespace("CopyChat", defaults)

	local frame = CreateFrame("Frame", "ChattyChattyBangBangCopyFrame", UIParent)
	tinsert(UISpecialFrames, "ChattyChattyBangBangCopyFrame")
...
function mod:OnEnable()
	ChattyChattyBangBang:AddMenuHook(self, "Menu")
...
function mod:OnDisable()
	ChattyChattyBangBang:RemoveMenuHook(self)
	for i = 1, #buttons do
		buttons[i]:Hide()
	end
end
