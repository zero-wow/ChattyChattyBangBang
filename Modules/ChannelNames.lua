local mod = ChattyChattyBangBang:NewModule("Channel Names", "AceHook-3.0", "AceEvent-3.0")
...
function mod:OnInitialize()
	self.db = ChattyChattyBangBang.db:RegisterNamespace("ChannelNames", defaults)
