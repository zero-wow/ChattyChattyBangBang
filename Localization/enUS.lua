...
local L = AceLocale:NewLocale("ChattyChattyBangBang", "enUS", true)
if not L then return end

-- ./ChattyChattyBangBang.lua
L["ChattyChattyBangBang"] = true
...
L["Enabled"] = true
L["Disabled"] = true
L["ChattyChattyBangBang Settings"] = true
L["Welcome to ChattyChattyBangBang! Type /ChattyChattyBangBang to configure."] = true
L["Profiles"] = true
